...
public class SQLQueries {
    ...
    public static final String INSERT_CREDENTIALS = "INSERT INTO login (username, password, id_reader) VALUES (?, ?, ?)";
    public static final String DELETE_CREDENTIALS_BY_READER_ID = "DELETE FROM login WHERE id_reader = ?";
    ...
    public static final String UPDATE_CREDENTIALS = "UPDATE login SET password = ? WHERE username = ?";
