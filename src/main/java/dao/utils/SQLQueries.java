...
public class SQLQueries {
    ...
    public static final String SELECT_READER_FROM_ID_WITH_LOGIN_QUERY = "SELECT * FROM reader inner join login on reader.id_reader = login.id_reader WHERE reader.id_reader = ?";
