...
public class SQLQueries {
    ...
    public static final String SELECT_READER_WITH_LOGIN_FROM_ID_QUERY = "SELECT * FROM reader inner join login on reader.id = login.id_reader WHERE reader.id = ?";
    public static final String SELECT_READERS_WITH_LOGIN_QUERY = "select * from reader inner join login on reader.id = login.id_reader";
    public static final String SELECT_READERS_WITH_LOGIN_BY_ARTICLE_TYPE_QUERY = "SELECT * FROM reader inner join login on reader.id = login.id_reader WHERE id IN (SELECT id_reader FROM readarticle WHERE id_article IN (SELECT id_article FROM article WHERE id_type = ?))";
    public static final String SELECT_READERS_WITH_LOGIN_BY_NEWSPAPER_QUERY = "select * from reader inner join login on reader.id = login.id_reader where reader.id in (select id_reader from subscribe where id_newspaper = ?)";
    ...
    public static final String SELECT_LOGIN_BY_ID_QUERY = "SELECT * FROM login WHERE id_reader = ?";
